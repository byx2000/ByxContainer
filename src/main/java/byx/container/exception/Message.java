...
public final class Message {
    ...
    public static String constructorNotFound(Class<?> type, Object[] params) {
        return String.format("Cannot find constructor of type \"%s\" with parameters %s.", type.getCanonicalName(), Arrays.toString(params));
    }
    ...
    public static String staticFactoryNotFound(Class<?> factory, String methodName, Object[] params) {
        return String.format("Cannot find static factory \"%s\" of type \"%s\" with parameters %s.", methodName, factory.getCanonicalName(), Arrays.toString(params));
    }
    ...
    public static String instanceFactoryNotFound(Class<?> type, String methodName, Object[] params) {
        return String.format("Cannot find instance factory \"%s\" of type \"%s\" with parameters %s.", methodName, type.getCanonicalName(), Arrays.toString(params));
    }
    ...
    public static String propertyNotFount(Class<?> type, String property, Class<?> valueType) {
        return String.format("Cannot find property \"%s\" in \"%s\" of type \"%s\".", property, type.getCanonicalName(), valueType.getCanonicalName());
    }
    ...
    public static String setterNotFound(Class<?> type, String setterName, Object[] params) {
        return String.format("Cannot find setter \"%s\" of type \"%s\" with parameters %s.", setterName, type.getCanonicalName(), Arrays.toString(params));
    }
    ...
    public static String parameterNotNull(String name) {
        return String.format("Parameter \"%s\" cannot be null.", name);
    }
    ...
    public static String componentNotFoundWithId(String id) {
        return String.format("Cannot find component with id \"%s\".", id);
    }
    ...
    public static String invalidClassName(String className) {
        return String.format("Incorrect class name: %s.", className);
    }
    ...
    public static String componentNotFoundWithType(Class<?> type) {
        return String.format("Cannot find component with type \"%s\".", type.getCanonicalName());
    }
    ...
    public static String multiComponentsWithType(Class<?> type) {
        return String.format("There is more than one component with type \"%s\".", type.getCanonicalName());
    }
