...
public class ReflectUtils {
    ...
    public static <T> T create(Class<T> type, Object... params) {
        try {
            ...
            throw new RuntimeException(String.format("Cannot invoke constructor of \"%s\" with parameters %s.", type.getCanonicalName(), Arrays.toString(params)), e);
        }
    }
    ...
    public static <T> T call(Class<?> type, String methodName, Object... params) {
        try {
            ...
            throw new RuntimeException(String.format("Cannot invoke static method \"%s\" of \"%s\" with parameters %s.", methodName, type.getCanonicalName(), Arrays.toString(params)), e);
        }
    }
    ...
    public static <T> T call(Object obj, String methodName, Object... params) {
        try {
            ...
            throw new RuntimeException(String.format("Cannot invoke method \"%s\" of \"%s\" with parameters %s.", methodName, obj.getClass().getCanonicalName(), Arrays.toString(params)), e);
        }
    }
